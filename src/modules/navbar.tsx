...
export default function Navbar() {
	...
	const toggleSidebar = () => { sidebarState ? dispatch((setSidebar(false))) : dispatch((setSidebar(true))) }


	return (
		<motion.div initial={{ translateY: "-10rem" }} animate={{ translateY: "0" }} transition={{ duration: 0.1, ease: "backInOut" }} className={navbarState ? "navbar" : "navbar active"}>
			<div className="content">
				<section>
					<svg onClick={toggleSidebar} viewBox="0 0 24 24" width="30" height="30" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M4 6H20M7 12H17M9 18H15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></g></svg>
					<h1>JUSTNOTES</h1>
				</section>
				<button onClick={() => route.push("/write")}>
